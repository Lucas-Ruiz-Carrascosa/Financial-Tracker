...
with tab1:
    ...
    st.subheader("Important: refresh the app after you download your file or wish to use another file, or close the window. Especially if it is not your computer.")
